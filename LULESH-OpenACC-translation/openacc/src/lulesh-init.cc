...
// Code was translated using: /mnt/lbosm1/home/yonif/LULESH-GPU/3_OpenACC-translation-present-alloc/openacc/src/intel-application-migration-tool-for-openacc-to-openmp/src/intel-application-migration-tool-for-openacc-to-openmp -overwrite-input -suppress-openacc -present=alloc -no-original-openmp-conditional-define src
